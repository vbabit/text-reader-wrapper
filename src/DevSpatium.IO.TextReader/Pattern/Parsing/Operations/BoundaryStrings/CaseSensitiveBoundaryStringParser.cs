...
{
    internal sealed class CaseSensitiveBoundaryStringParser : BaseBoundaryStringParser
    {
        private readonly IPatternScope _innerScope = new CaseSensitiveBoundaryStringScope();
        private readonly TextComparison _textComparison;

        public CaseSensitiveBoundaryStringParser(TextComparison textComparison)
        ...
        protected override IBoundaryString CreateBoundaryString(string value, PatternPosition position)
            => new DefaultBoundaryString(value, false, _textComparison);
        ...
        private static EscapeOptions CreateEscapeOptions() => new EscapeOptions
        {
            NonLiteralTokens = new[]
            {
                ...
                new EscapeOptions.NonLiteralToken(Tokens.CaseSensitiveBoundaryStringQuotationMark),
